...
# docker build -t jiro_review .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name jiro_review jiro_review
...
# (重要) PATH を通す（bundle/rails が見つかるように）
